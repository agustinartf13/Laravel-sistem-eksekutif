...
<div class="page-content-wrapper">
  ...
  <div class="col-12">
      <div class="card m-b-20">
          <div class="card-body">
    <h4 class="mt-0 header-title" style="font-size: 22px">Data User</h4>
    <hr>
    @if(session('status'))
    ...
    @endif
    <button id="create_user" name="create_user" class="btn btn-danger waves-effect waves-light" style="float: right" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Add User</button>
    <br><br><br>
      <table id="datatable" class="table table-bordered table-striped dt-responsive nowrap  mt-5" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    <thead>
        <tr>
          <th>No.</th>
          <th>Username</th>
                    ...
                    <form id="user_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col">
                            ...
                            <input type="number" name="no_telphone" id="no_telphone" class="form-control"  placeholder="No Telphone" >
                          </div>
                        </div>
                        <div class="row mt-3">
                          <div class="col">
                          ...
                          <div class="form-check d-inline mr-3">
                            <input class="form-check-input mr-5" type="radio" name="gender" id="laki-laki" value="LAKI-LAKI">
                              <label class="form-check-label">
                                LAKI-LAKI
                              </label>
                          </div>
                          <div class="form-check d-inline">
                            <input class="form-check-input mr-5" type="radio" name="gender" id="perempuan" value="PEREMPUAN">
                              <label class="form-check-label">
                                PEREMPUAN
                              </label>
                          </div>
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="form-group mt-2">
                          <div>
                            ...
                            <input type="submit" name="action_button" id="action_button" class="btn btn-success waves-effect waves-light" value="Created"/>
                            <button type="reset" class="btn btn-warning waves-effect waves-light btn-flat">Reset</button>
    ...
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'no_telphone', name: 'no_telphone' },
