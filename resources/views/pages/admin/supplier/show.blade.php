...
<div class="card-body box-profile">
    ...
    <a href="{{ route('admin.supplier.edit', ['supplier' => $supplier->id]) }}" class="btn btn-info btn-block"><b>Edit
            Supplier</b></a>
    ...
    <div class="row mt-4">
        ...
        <div class="col">
            <a href="{{route('admin.supplier.status', $supplier->id)}}?status=INACTIVE"
