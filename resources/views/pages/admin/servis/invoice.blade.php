...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <h6>
                    <li class="breadcrumb-item">Tanggal Transaksi : {{$service->tanggal_servis}}</li>
                </h6>
            </ol>
        </div>
    </div>
                ...
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <address class="text-justify" style="float: right">
                                        Name Customer: {{$service->customer_servis}}<br>
                                        Address: {{$service->alamat}}<br>
                                        Phone: {{formatPhoneNum($service->no_telphone)}}<br>
                                        No Polis: {{$service->no_polis}}<br>
                                        Tipe Motor: {{$service->motor->name}} | {{$service->motor->tipe_motor}}
                                    </address>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-4 " style="margin-top: -110px;">
                            <div class="table table-responsive table-borderless">
                                <table class="table">
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="width: 130px;"><strong>Tipe Service</strong></th>
                                            <td>{{$service->dtlservice[0]->tipe_servis}}</td>
                                        </tr>
                                        <tr>
                                            <th><strong>Keluhan</strong></th><br>
                                            <td>{{$service->dtlservice[0]->keluhan}}</td><br>
                                        </tr>
                                        <tr>
                                            <th><strong>Waktu Service</strong></th><br>
                                            <td>{{$service->dtlservice[0]->waktu_servis}}</td>
                                        </tr>
                                        <tr>
                                            <th><strong>Harga Jasa</strong></th><br>
                                            <td>{{rupiah($service->dtlservice[0]->harga_jasa)}}</td><br>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div>
                                <div class="p-2">
                                    <h3 class="font-16"><strong>Ganti Sparepart</strong></h3>
                                </div>
                                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <address>
                                <h6> <strong>Total Transaksi</strong>&nbsp;&nbsp;{{rupiah($service->sub_total)}}</h6>
                            </address>
                        </div>
