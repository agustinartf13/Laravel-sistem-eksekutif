...
<div class="card-body box-profile">
    ...
    <a href="{{ route('operator.supplier.edit', ['supplier' => $supplier->id]) }}" class="btn btn-info btn-block"><b>Edit Supplier</b></a>

    <div class="row mt-4">
        <div class="col">
            <a href="{{route('operator.supplier.status', $supplier->id)}}?status=ACTIVE" class="btn btn-success btn-block">
                <i class="fa fa-check"></i> Set Active
            </a>
        </div>
        <div class="col">
            <a href="{{route('operator.supplier.status', $supplier->id)}}?status=INACTIVE" class="btn btn-primary btn-block">
