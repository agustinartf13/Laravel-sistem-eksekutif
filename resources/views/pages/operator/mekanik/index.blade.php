                ...
                @endif
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="post" action="{{ route('operator.mekanik.importexcelmekanik') }}" enctype="multipart/form-data">
                    ...
                    <a
                    href="{{ route('operator.mekanik.exportexcelmekanik') }}"
                    ...
                    <a
                    href="{{ route('operator.mekanik.exportpdfmekanik') }}"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('operator.api.mekanik')}}"
            },
            columns: [{
                    data: 'id',
                    sortable: true,
        ...
        $('#mekanikForm').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Created') {
                action_url = "{{route('operator.mekanik.store')}}";
            }

            if ($('#action').val() == 'Updated') {
                action_url = "{{route('operator.mekanik.update', 'hidden_id->id')}}";
            }
        ...
        swal({
            ...
            preConfirm: function () {
                return new Promise(function (resolve) {
                    $.ajax({
                            url: "{{ url('operator/mekanik') }}" + '/' + mekanikId,
                            type: "DELETE",
                            data: {
                                '_method': 'DELETE',
                                '_token': csrf_token
