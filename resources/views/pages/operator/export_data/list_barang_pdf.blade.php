...
<body>
    ...
    <br>
    <p class="repot">Repot List Barang</p>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="font-size: 12px">Harga Dasar</th>
                <th style="font-size: 12px">Harga Jual</th>
        ...
        <tbody>
            ...
            <tr>
                <td style="font-size: 12px">{{ $barang->kode_barang }}</td>
                <td style="font-size: 12px">{{ $barang->name_barang }}</td>
                <td style="font-size: 12px">{{ $barang->category->name }}</td>
                <td style="font-size: 12px">{{ $barang->details_barang->harga_dasar }}</td>
                <td style="font-size: 12px">{{ $barang->details_barang->harga_jual }}</td>
                <th style="font-size: 12px">{{ $barang->details_barang->stock }}</th>
            </tr>
            @endforeach
        </tbody>
    </table>
