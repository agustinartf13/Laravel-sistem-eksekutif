        ...
        <div class="col-12">
            <div class="card m-b-20">
                ...
                <div class="modal-dialog" role="document">
                    <form method="post" action="{{ route('operator.barang.importexcelbarang') }}" enctype="multipart/form-data">
                    ...
                    <a
                    href="{{ route('operator.barang.exportexcellistbarang') }}"
                    ...
                    <a
                    href="{{ route('operator.barang.exportpdflistbarang') }}"
        ...
        $(document).ready(function () {
            ...
            $('#barangForm').on('submit', function (event) {
                ...
                if ($('#action').val() == 'Created') {
                    action_url = "{{route('operator.barang.store')}}";
                }

                if ($('#action').val() == 'Updated') {
                    action_url = "{{route('operator.barang.update', 'id')}}"
                }
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                                url: "{{ url('operator/barang') }}" + '/' + barangId,
                                type: "DELETE",
                                data: {
                                    '_method': 'DELETE',
                                    '_token': csrf_token
