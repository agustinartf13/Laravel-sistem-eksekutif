    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('operator.pembelian.index')}}">Penjualan</a></li>
                <li class="breadcrumb-item"><a href="{{route('operator.pembelian.create')}}">Add Pebjualan</a></li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <form id="add_barang" action="{{route('operator.penjualan.update', $penjualan->id)}}" method="POST"
                        ...
                        <div class="form-group mt-3">
                            <div>
                                ...
                                <a href="{{route('operator.penjualan.index')}}"
