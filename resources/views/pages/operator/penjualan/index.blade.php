...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('operator.dashboard')}}">Dashoard</a></li>
                <li class="breadcrumb-item"><a href="{{route('operator.penjualan.index')}}">Penjualan</a></li>
                <li class="breadcrumb-item"><a href="{{route('operator.penjualan.create')}}"></a>Add Penjualan</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <script text="text/javascript">
        $(document).ready(function () {
            $('#datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{route('operator.api.penjualan')}}",
                columns: [{
                        data: 'id',
                        sortable: true,
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                                url: "{{ url('operator/penjualan') }}" + '/' + penjualanId,
                                type: "DELETE",
                                data: {
                                    '_method': 'DELETE',
                                    '_token': csrf_token
