...
<div class="card-body box-profile">
    ...
    <a href="{{ route('toplevel.mekanik.edit', ['mekanik' => $mekanik->id]) }}" class="btn btn-info btn-block"><b>Edit Mekanik</b></a>

    <div class="row mt-4">
        <div class="col">
            <a href="{{route('toplevel.mekanik.status', $mekanik->id)}}?status=ACTIVE" class="btn btn-success btn-block">
                <i class="fa fa-check"></i> Set Active
            </a>
        </div>
        <div class="col">
            <a href="{{route('toplevel.mekanik.status', $mekanik->id)}}?status=INACTIVE" class="btn btn-primary btn-block">
