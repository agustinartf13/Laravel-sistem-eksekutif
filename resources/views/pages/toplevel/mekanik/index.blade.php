                ...
                @endif
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="post" action="{{ route('toplevel.mekanik.importexcelmekanik') }}" enctype="multipart/form-data">
                    ...
                    <a
                    href="{{ route('toplevel.mekanik.exportexcelmekanik') }}"
                    ...
                    <a
                    href="{{ route('toplevel.mekanik.exportpdfmekanik') }}"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('toplevel.api.mekanik')}}"
            },
            columns: [{
                    data: 'id',
                    sortable: true,
        ...
        $('#mekanikForm').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Created') {
                action_url = "{{route('toplevel.mekanik.store')}}";
            }

            if ($('#action').val() == 'Updated') {
                action_url = "{{route('toplevel.mekanik.update', 'hidden_id->id')}}";
            }
        ...
        swal({
            ...
            preConfirm: function () {
                return new Promise(function (resolve) {
                    $.ajax({
                            url: "{{ url('toplevel/mekanik') }}" + '/' + mekanikId,
                            type: "DELETE",
                            data: {
                                '_method': 'DELETE',
                                '_token': csrf_token
