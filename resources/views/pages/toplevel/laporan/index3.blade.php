        ...
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('toplevel.dashboard') }}">Dashboard</a>
                </li>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button id="data-year" type="submit" class="btn btn-primary btn-sm">
                                    Submit
                                </button>
                            </div>
                        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- <a href="{{ route('toplevel.laporan.exportexcel') }}" class="btn btn-success btn-flat d-inline mr-3"
                        style="float: right;"><i class="fa fa-print"></i> Excel</a>
                    <a href="{{ route('toplevel.laporan.exportpdfservice') }}" --}}
