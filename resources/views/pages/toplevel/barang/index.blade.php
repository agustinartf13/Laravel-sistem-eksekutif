        ...
        <div class="col-12">
            <div class="card m-b-20">
                ...
                <div class="modal-dialog" role="document">
                    <form method="post" action="{{ route('toplevel.barang.importexcelbarang') }}" enctype="multipart/form-data">
                    ...
                    <a
                    href="{{ route('toplevel.barang.exportexcellistbarang') }}"
                    ...
                    <a
                    href="{{ route('toplevel.barang.exportpdflistbarang') }}"
