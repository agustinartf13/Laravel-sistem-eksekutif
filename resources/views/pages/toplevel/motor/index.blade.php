                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="post" action="{{ route('toplevel.motor.importexcelmotor') }}" enctype="multipart/form-data">
                    ...
                    <a
                    href="{{ route('toplevel.motor.exportexcelmotor') }}"
                    ...
                    <a
                    href="{{ route('toplevel.motor.exportpdfmotor') }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#motorForm').on('submit', function (event) {
                ...
                if ($('#action').val() == 'Created') {
                    action_url = "{{route('toplevel.motor.store')}}";
                }

                if ($('#action').val() == 'Updated') {
                    action_url = "{{route('toplevel.motor.update', 'hidden_id->id')}}";
                }
        ...
        function SwalUpdate(motorId) {
            ...
            $('#motorForm').on('submit', function (event) {
                ...
                if ($('#action').val() == 'Updated') {
                    action_url = "{{route('toplevel.motor.update', 'id')}}";
                }
                ...
                $.ajax({
                    url: "/toplevel/motor/" + motorId + "/edit",
                    data: {
                        '_method': 'POST',
                        '_token': csrf_token
                    },
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                                url: "{{ url('toplevel/motor') }}" + '/' + motorId,
                                type: "DELETE",
                                data: {
                                    '_method': 'DELETE',
                                    '_token': csrf_token
