                            ...
                            <form action="{{route('logout')}}" method="POST">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <a class="dropdown-item d-block" href="#"><i class="mdi mdi-settings m-r-5"></i>
                                        Settings</a>
                                    <button class="dropdown-item text-danger" type="submit" id="logout"><i
                                            class="mdi mdi-power text-danger"></i> Logout</button>
                                </div>
                            </form>
                        </div>
                    </li>
                            ...
                            <form action="{{route('logout')}}" method="POST">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:void(0)" class="dropdown-item"><i
                                                class="mdi mdi-account-circle m-r-5"></i> <span
                                                class="text-dark">Profile</span>
                                            <div class="ripple-wrapper"></div>
                                        </a></li>
                                    <li><a href="javascript:void(0)" class="dropdown-item"><i
                                                class="mdi mdi-settings m-r-5"></i> <span
                                                class="text-dark">Settings</span></a></li>
                                    <li>
                                        <button type="submit" class="dropdown-item"><i
                                                class="mdi mdi-power m-r-5"></i><span class="text-dark">Logout</span>
                                        </button>
                                    </li>
                                </ul>
                            </form>
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i
                                    class="mdi mdi-database-search"></i><span> Manage Data <span
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i
                                    class="mdi mdi-database-search"></i><span> Transaksi <span
                                        class="float-right menu-arrow"><i class="mdi mdi-plus"></i></span> </span></a>
                            <ul class="submenu">
                                <li>
