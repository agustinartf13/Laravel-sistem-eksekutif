...
class Service extends Model
{
    ...
    protected $fillable = ['mekanik_id', 'motor_id', 'customer_servis', 'alamat', 'no_telphone', 'invocie_number', 'no_polis', 'status', 'tanggal_servis', 'total_harga', 'sub_total', 'profit', 'created_by', 'updated_by'];
