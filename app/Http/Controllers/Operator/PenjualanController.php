...
class PenjualanController extends Controller
{
    ...
    {
        $barangs = Barang::all();
        return view('pages.operator.penjualan.create', [
            'barangs' => $barangs,
        ]);
    }
    ...
    public function store(PenjualanRequest $request)
    {
        foreach ($request->get('barang') as $key => $brg) {
            ...
            if ($request->get('qty')[$key] > $stock->stock) {
                return redirect()->route('operator.penjualan.create')->with('status', 'Stock' . $barangs->name_barang . 'Tidak Mencukupi');
            }
        }
    ...
    public function show($id)
    {
        ...
        return view('pages.operator.penjualan.show')->with([
            'penjualan' => $penjualan
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        $barangs = Barang::all();
        return view('pages.operator.penjualan.edit', [
    ...
    public function invoice(Request $request, $id)
    {
        ...
        return view('pages.operator.penjualan.invoice', [
            'penjualan' => $penjualan
        ]);
    }
