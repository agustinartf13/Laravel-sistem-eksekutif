...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.operator.categories.index', [
    ...
    public function apicategories()
    {
        ...
        return DataTables::of($categories)
            ->addColumn('show_photo', function ($categories) {
                ...
                return ''.
                    '<a href="' . route('operator.categories.edit', ['category' => $categories->id]) . '" class="btn btn-flat btn-warning btn-sm"><i class="fa fa-edit"></i></a>' .
    ...
    {
        return view('pages.operator.categories.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.operator.categories.edit', ['category' => $categories]);
    }
