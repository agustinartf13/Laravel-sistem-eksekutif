...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.operator.servis.index', [
            'service' => $service
        ]);
    }
    ...
    public function create()
    {
        ...
        $motors = Motor::all();
        return view('pages.operator.servis.create', [
    ...
    public function invoice(Request $request, $id)
    {
        ...
        return view('pages.operator.servis.invoice', [
            'service' => $service
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.operator.servis.show')->with([
            'service' => $service
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.operator.servis.edit', [
