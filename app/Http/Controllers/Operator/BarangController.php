...
class BarangController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($barangs);
        return view('pages.operator.barang.index', [
    ...
    public function apibarang()
    {
        ...
        return DataTables::of($barangs)
            ->addColumn('action', function ($barangs) {
                return ''.
                '<a href="#mymodal" data-remote="' . route('operator.barang.show', ['barang' => $barangs->id]) . '" data-toggle="modal" data-target="#mymodal" data-title="' . $barangs->name_barang . '" class="btn btn-info btn-flat btn-sm"><i class="fa fa-eye"></i></a>' .
                '&nbsp;<a href="' . route('operator.barang.edit', ['barang' => $barangs->id]) . '" class="btn btn-warning btn-flat btn-sm"><i class="fa fa-edit"></i></a>'.
    ...
    public function create()
    {
        $categories = Category::all();
        $barangs = Barang::all();
        return view('pages.operator.barang.create', ['barangs' => $barangs, 'categories' => $categories]);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.operator.barang.show')->with([
            'barang' => $barang
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        // dd($barangs);
        return view('pages.operator.barang.edit', [
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('pages.operator.export_data.list_barang_pdf', [
    ...
    public function importExcel(Request $request)
    {
        ...
        return redirect()->route('operator.barang.index');
    }
}
