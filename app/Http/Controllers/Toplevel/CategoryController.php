...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.toplevel.categories.index', [
    ...
    public function apicategories()
    {
        ...
        return DataTables::of($categories)
            ->addColumn('show_photo', function ($categories) {
                ...
                return ''.
                    '<a href="' . route('toplevel.categories.edit', ['category' => $categories->id]) . '" class="btn btn-flat btn-warning btn-sm"><i class="fa fa-edit"></i></a>' .
    ...
    {
        return view('pages.toplevel.categories.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.toplevel.categories.edit', ['category' => $categories]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('toplevel.categories.index', [
            'id' => $id
