...
class MotorController extends Controller
{
    ...
    {
        $motor = Motor::all();
        return view('pages.toplevel.motor.index', [
            'motors' => $motor
        ]);
    }
    ...
    public function apimotor()
    {
        ...
        return DataTables::of($motors)
            ->addColumn('action', function ($motors) {
                return '<a href="' . route('toplevel.motor.edit', ['motor' => $motors->id]) . '" class="btn btn-warning btn-flat btn-sm"><i class="fa fa-edit"></i></a>' .
    ...
    {
        return view('pages.toplevel.motor.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.toplevel.motor.edit', ['motor' => $motors]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('toplevel.motor.edit', $id)->with('status', 'Motor successfully Updated!');
    }
